...
const { update: updateCustomerSchema } = require("@/validation/customer.validation");
...
exports.PUT = async function (req, { params }) {
  try {
    ...
    const customer = await customerService.update(data, params._id);
...
exports.DELETE = async function (req, { params }) {
  try {
    ...
    const customer = await customerService.delete(params._id);
